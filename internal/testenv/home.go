...
// SetTestAppHome sets YANTA_HOME for testing.
func SetTestAppHome(t *testing.T, dir string) func() {
	t.Helper()
	old := os.Getenv("YANTA_HOME")
	os.Setenv("YANTA_HOME", dir)
	return func() {
		if old == "" {
			_ = os.Unsetenv("YANTA_HOME")
		} else {
			_ = os.Setenv("YANTA_HOME", old)
		}
	}
}
