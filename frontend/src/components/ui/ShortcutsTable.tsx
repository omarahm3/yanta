...
export const ShortcutsTable: React.FC<ShortcutsTableProps> = ({
  shortcuts,
  className,
}) => {
  return (
    <div className={cn("w-full text-sm", className)}>
      ...
      <div className="grid grid-cols-[1fr_200px] gap-4 pb-3 mb-3 border-b border-border">
        <div className="text-text-dim text-xs uppercase tracking-wider font-medium">
          ACTION
        </div>
        <div className="text-text-dim text-xs uppercase tracking-wider font-medium">
          SHORTCUT
      ...
      <div className="space-y-0.5">
        {shortcuts.map((shortcut) => (
          <div
            key={shortcut.id}
            className="grid grid-cols-[1fr_200px] gap-4 py-2 items-center"
          >
