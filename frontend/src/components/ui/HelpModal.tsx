              ...
              <div>
                ...
                <div className="grid gap-2">
                  {filteredGlobalCommands.map((cmd, idx) => (
                    <div key={idx} className="grid grid-cols-[minmax(160px,auto)_1fr] items-baseline gap-3 sm:gap-4 font-mono text-sm group py-1.5 px-2 -mx-2 rounded hover:bg-bg/50 transition-colors">
                    ...
                    <div key={category}>
                      ...
                      <div className="grid gap-2">
                        {groupedHotkeys[category].map((hotkey) => (
                          <div key={hotkey.id} className="grid grid-cols-[minmax(140px,auto)_1fr] items-baseline gap-3 sm:gap-4 font-mono text-sm group py-1.5 px-2 -mx-2 rounded hover:bg-bg/50 transition-colors">
