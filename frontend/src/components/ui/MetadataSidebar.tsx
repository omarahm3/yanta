...
export const MetadataSidebar: React.FC<MetadataSidebarProps> = ({
  ...
  return (
    <aside
      className={cn(
        "w-60 bg-surface border-r border-border p-5 overflow-y-auto",
        className
      )}
    >
      {/* Entry ID */}
      ...
      <div
        className={cn(
          ...
          getProjectColor(metadata.projectType)
        )}
      >
        {metadata.project}
      </div>
      ...
      {/* Type */}
      <div className="mb-6">
        <div className="text-xs uppercase tracking-wider text-text-dim mb-2">
          TYPE
        </div>
        <div>
