...
import { GetSystemInfo, SetLogLevel } from "../../wailsjs/go/system/Service";
...
export const Settings: React.FC<SettingsProps> = ({ onNavigate }) => {
  ...
  // Get sidebar sections using the hook with settings-specific sections
  const settingsItems = [
    { id: "shortcuts", label: "shortcuts", onClick: () => scrollToSection("shortcuts") },
    { id: "logging", label: "logging", onClick: () => scrollToSection("logging") },
    ...(FEATURES.GIT_SYNC ? [{ id: "sync", label: "sync", onClick: () => scrollToSection("sync") }] : []),
    ...(FEATURES.EXPORT ? [{ id: "export", label: "export", onClick: () => scrollToSection("export") }] : []),
        ...
        <div className="max-w-4xl mx-auto">
          {needsRestart && (
            <div className="mb-6 p-4 bg-yellow-900/30 border border-yellow-700 rounded">
              <div className="text-yellow-400 font-medium mb-1">Restart Required</div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-text-dim">
                    Current level: <span className="font-mono text-accent">{systemInfo?.app.logLevel || "info"}</span>
                  </div>
                </div>
              </div>
            </SettingsSection>
          ...
          {FEATURES.GIT_SYNC && (
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({
                      ...prev,
                      gitSync: { ...prev.gitSync, remoteUrl: e.target.value },
                    }))
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  <option value="realtime">Real-time (on every save)</option>
          ...
          {FEATURES.EXPORT && (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm text-text">Include project context</div>
                <Toggle
