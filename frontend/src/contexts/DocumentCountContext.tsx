...
const DocumentCountContext = createContext<DocumentCountContextValue | null>(
  null
);
...
export const DocumentCountProvider: React.FC<DocumentCountProviderProps> = ({
  children,
}) => {
...
export const useDocumentCount = (): DocumentCountContextValue => {
  ...
  if (!context) {
    throw new Error(
      "useDocumentCount must be used within a DocumentCountProvider"
    );
  }
  return context;
};
